...
namespace GUI
{
    public partial class frmConsultaCaracteristicaManufaturado1 : Form
    {
        public int codigo = 0;
        public frmConsultaCaracteristicaManufaturado1()
        {
            InitializeComponent();
        }
        ...
        private void frmConsultaCaracteristicaManufaturado1_Load(object sender, EventArgs e)
        {
